<template> 
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <router-link class="nav-link" exact-active-class="active" to="/equipment">Equipment</router-link>
      </li>
      <li class="nav-item">
        <router-link class="nav-link" exact-active-class="active" to="/about">About</router-link>
      </li>
      <li class="nav-item">
          <router-link class="nav-link" exact-active-class="active" to="/signup">Sign Up</router-link>
      </li>
       <li class="nav-item">
